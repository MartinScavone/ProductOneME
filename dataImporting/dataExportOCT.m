...
%%Octave-only imports - uses XLSWRITE function on file with name:  finalName"saveDataName.xlsx" file (defined from the main script)
...
rangeToExport    = strcat('h9:h9',string(finalRowToExport)) ;
